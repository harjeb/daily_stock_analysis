...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "ALPHASIFT_DAILY_POOL_FILE": {
        "title": "AlphaSift Daily Pool File",
        "description": "Path to the user-maintained stock pool file used by the daily AlphaSift recommendation job. Supports TXT/CSV-style files with codes separated by commas, whitespace, or one code per line.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "data/pools/watch_pool.csv",
        "options": [],
        "validation": {},
        "display_order": 19,
        "help_key": "settings.data_source.ALPHASIFT_DAILY_POOL_FILE",
        "examples": [
    ...
    "ALPHASIFT_DAILY_STRATEGIES": {
        "title": "AlphaSift Daily Strategies",
        "description": "Comma-separated AlphaSift strategies used for the daily pool recommendation job. Each strategy returns Top N before DSA de-duplicates candidates.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "balanced_alpha",
        "options": [],
        "validation": {},
        "display_order": 20,
        "help_key": "settings.data_source.ALPHASIFT_DAILY_STRATEGIES",
        "examples": [
    ...
    "ALPHASIFT_DAILY_TOP_N": {
        "title": "AlphaSift Daily Top N",
        "description": "Number of candidates to take from each AlphaSift strategy before de-duplication.",
        "category": "data_source",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 21,
        "help_key": "settings.data_source.ALPHASIFT_DAILY_TOP_N",
        "examples": [
    ...
    "ALPHASIFT_DAILY_NOTIFY": {
        "title": "AlphaSift Daily Notify",
        "description": "Append the daily AlphaSift pool recommendation section to scheduled reports and merged notifications. This does not run DSA single-stock analysis for the pool.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 22,
        "help_key": "settings.data_source.ALPHASIFT_DAILY_NOTIFY",
        "examples": [
            "ALPHASIFT_DAILY_NOTIFY=true",
            "ALPHASIFT_DAILY_NOTIFY=false",
        ],
        "docs": [
            {
                "label": "AlphaSift 集成说明",
    ...
    "ALPHASIFT_DAILY_USE_LLM": {
        "title": "AlphaSift Daily LLM Ranking",
        "description": "Whether the daily pool recommendation job allows AlphaSift LLM ranking. When disabled, AlphaSift returns local factor ranking only.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 23,
        "help_key": "settings.data_source.ALPHASIFT_DAILY_USE_LLM",
        "examples": [
    ...
    "WOLF_DAILY_REPORT_ENABLED": {
        "title": "Wolf Daily Report",
        "description": "Append a daily-K-only Wolf-style post-market report to scheduled reports. It uses distilled rules, not raw source posts.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 24,
        "help_key": "settings.data_source.WOLF_DAILY_REPORT_ENABLED",
        "examples": ["WOLF_DAILY_REPORT_ENABLED=true"],
        "docs": [
            {
                "label": "Wolf 日K盘后分析",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/wolf-postmarket.md",
            },
        ],
    },
    "WOLF_DAILY_WHITELIST_ENABLED": {
        "title": "Wolf Whitelist Analysis",
        "description": "Evaluate a separate A-share whitelist as observe/probe/entry candidates in the Wolf daily report.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 25,
        "help_key": "settings.data_source.WOLF_DAILY_WHITELIST_ENABLED",
        "examples": ["WOLF_DAILY_WHITELIST_ENABLED=true"],
        "docs": [
            {
                "label": "Wolf 日K盘后分析",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/wolf-postmarket.md",
    ...
    "WOLF_DAILY_STOCK_LIST_ENABLED": {
        "title": "Wolf STOCK_LIST Analysis",
        "description": "Evaluate STOCK_LIST holdings/watchlist names in the Wolf daily report and produce operation-oriented notes.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 26,
        "help_key": "settings.data_source.WOLF_DAILY_STOCK_LIST_ENABLED",
        "examples": ["WOLF_DAILY_STOCK_LIST_ENABLED=true"],
        "docs": [
            {
                "label": "Wolf 日K盘后分析",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/wolf-postmarket.md",
    ...
    "WOLF_DAILY_WHITELIST_FILE": {
        "title": "Wolf Whitelist File",
        "description": "Path to the A-share whitelist file used by the Wolf daily report. Supports TXT/CSV-style code lists.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "data/pools/wolf_whitelist.csv",
        "options": [],
        "validation": {},
        "display_order": 27,
        "help_key": "settings.data_source.WOLF_DAILY_WHITELIST_FILE",
        "examples": ["WOLF_DAILY_WHITELIST_FILE=data/pools/wolf_whitelist.csv"],
        "docs": [
            {
                "label": "Wolf 日K盘后分析",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/wolf-postmarket.md",
    ...
    "WOLF_DAILY_MAX_CODES": {
        "title": "Wolf Max Codes",
        "description": "Fallback maximum per scope when hot-sector selection is unavailable or disabled. Hot-sector matches are not truncated by this value.",
        "category": "data_source",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 28,
        "help_key": "settings.data_source.WOLF_DAILY_MAX_CODES",
        "examples": ["WOLF_DAILY_MAX_CODES=30"],
        "docs": [
            {
                "label": "Wolf 日K盘后分析",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/wolf-postmarket.md",
    ...
    "WOLF_DAILY_HISTORY_DAYS": {
        "title": "Wolf History Days",
        "description": "Daily K-line lookback window used by the Wolf report for MA/BOLL/volume pattern checks.",
        "category": "data_source",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 29,
        "help_key": "settings.data_source.WOLF_DAILY_HISTORY_DAYS",
        "examples": ["WOLF_DAILY_HISTORY_DAYS=120"],
        "docs": [
            {
                "label": "Wolf 日K盘后分析",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/wolf-postmarket.md",
    ...
    "WOLF_DAILY_HOT_SECTOR_FILTER_ENABLED": {
        "title": "Wolf Hot Sector Filter",
        "description": "Use near-60d board performance to select whitelist candidates before running Wolf daily analysis.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 30,
        "help_key": "settings.data_source.WOLF_DAILY_HOT_SECTOR_FILTER_ENABLED",
        "examples": ["WOLF_DAILY_HOT_SECTOR_FILTER_ENABLED=true"],
        "docs": [
            {
                "label": "Wolf 日K盘后分析",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/wolf-postmarket.md",
    ...
    "WOLF_DAILY_HOT_SECTOR_TOP_N": {
        "title": "Wolf Hot Sector Top N",
        "description": "Number of top near-60d boards used as hot sectors. Set 0 to include every board above the minimum 60d change threshold.",
        "category": "data_source",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 31,
        "help_key": "settings.data_source.WOLF_DAILY_HOT_SECTOR_TOP_N",
        "examples": ["WOLF_DAILY_HOT_SECTOR_TOP_N=12"],
        "docs": [
            {
                "label": "Wolf 日K盘后分析",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/wolf-postmarket.md",
    ...
    "WOLF_DAILY_HOT_SECTOR_MIN_CHANGE_PCT": {
        "title": "Wolf Hot Sector Min 60D Change",
        "description": "Minimum near-60d board gain required for Wolf hot-sector selection.",
        "category": "data_source",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 32,
        "help_key": "settings.data_source.WOLF_DAILY_HOT_SECTOR_MIN_CHANGE_PCT",
        "examples": ["WOLF_DAILY_HOT_SECTOR_MIN_CHANGE_PCT=0"],
        "docs": [
            {
                "label": "Wolf 日K盘后分析",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/wolf-postmarket.md",
